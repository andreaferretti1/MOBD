function [neural_network_trained] = train_model(X_training, Y_training, X_eval, Y_eval, neural_network, training_hyperparams, is_validation)
...
% Addestro il modello
[W_trained, b_trained] = momentum_gradient_method(alpha, beta, X_training, Y_training, X_eval, Y_eval, neural_network, minibatch_size, epochs_num, regularization_parameter, is_validation);
